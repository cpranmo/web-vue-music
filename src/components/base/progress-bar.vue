<template>
    <!-- 条形进度条组件 -->
    <div class="progress-bar" ref="progressBar" @click="progressClick"> <!-- 进度条点击事件-->
        <div class="bar-inner"><!--    进度条整体的部分    -->
            ...
            ><!--    进度条的按钮部分  可以用触摸事件来调整播放的进度使用到 \(^o^)/~ h5 事件 -->
...
<script>
    import { prefixStyle } from "../../assets/js/dom"; // 这个是用来处理样式兼容的自定义前缀的
